...
Funcion ejercicio_11_EI
	// Entrada: definimos las variables que se utilizaran para crear un ciclo
	Definir edad,peso,estatura,sumEdad,sumPeso,sumEstatura Como Entero
	Definir cont18a25,contMayor36,contPeso18a35 Como Entero
	Definir proEdad,proPeso,proEstatura,proPeso18a35 Como Real
	sumEdad <- 0
	sumPeso <- 0
	sumEstatura <- 0
	cont18a25 <- 0
	contMayor36 <- 0
	contPeso18a35 <- 0
	// Proceso: Solicitamos los datos de los requerimientos para realizar el proceso
	Escribir 'Ingrese los valores enteros (debe terminar en 0):'
	// Aplicamos uso de Estructura Iterativa (Mientras-Hacer) con los datos recibidos
	Leer edad
	Mientras edad<>0 Hacer
		...
		sumEstatura <- sumEstatura+estatura
		Si edad>=18 Y edad<=25 Entonces
			cont18a25 <- cont18a25+1
		FinSi
		Si edad>36 Entonces
			contMayor36 <- contMayor36+1
		FinSi
		Si edad>=18 Y edad<=35 Entonces
			contPeso18a35 <- contPeso18a35+1
			proPeso18a35 <- proPeso18a35+peso
		FinSi
		Leer edad
	FinMientras
	// Resolvemos ultimos comprobantes y
	// Salida: Presentamos resultadosm obtenidos del sistema 
	proEdad <- sumEdad/(cont18a25+contMayor36)
	proPeso <- sumPeso/(cont18a25+contMayor36)
	proEstatura <- sumEstatura/(cont18a25+contMayor36)
	proPeso18a35 <- proPeso18a35/contPeso18a35
	Escribir 'La edad promedio de las personas presentadas es : ',proEdad
	Escribir 'El peso promedio de las personas presentadas es: ',proPeso
	Escribir 'La estatura promedio de las personas presentadas es: ',proEstatura
	Escribir 'Las personas entre una edad de 18 a 25 años es: ',contEdad
	Escribir 'Las personas mayores de 36 años: ',contPeso
FinFuncion
...
Funcion ejercicio_13_EI
	...
	// Proceso: Se solicitara que ingrese 2 valoras para realizar las pruebas y dar los resultados
	Escribir 'Ingrese los valores de la multiplicacion con sumas sucesivas que desea realizar'
	Leer m,n
	// Proceso: realizamos la suma
	suma <- 0
	Para i<-1 Hasta n Hacer
		suma <- suma+m
		Escribir suma-m,' + ',m,' = ',suma
	FinPara
	Escribir 'El resultado de la suma sucesiva de ',m,' x ',n,' = ',suma
FinFuncion
...
Funcion ejercicio_14_EI
	...
	Para i<-1 Hasta cantidad Hacer
		...
		suma <- suma+num
	FinPara
	Escribir 'El promedio de la serie de numeros es ',suma
FinFuncion
...
Funcion ejercicio_15_EI
	...
	Definir numerador,denomidador Como Real
	...
	Mientras resta-denominador>=0 Hacer
		...
		contador <- contador+1
	FinMientras
	Escribir 'La division de ',numerador,'/',denominador,' = ',contador
FinFuncion
...
Algoritmo Proyecto
	...
	Dimension menuPrincipal[4],menuNumeros[11],menuCadenas[11],menuarreglos[15]
	...
	Mientras opc<>'4' Hacer
		...
		Segun opc  Hacer
			...
			'3':
				opcn <- ''
				Mientras opcn<>'11' Hacer
					opcn <- presentarMenu('Menu Numeros',menuarreglos,14)
					Segun opcn  Hacer
						'1':
							Escribir '--------------------------------------------------- '
							ejercicio_1_EI
